...
for directory in get_directories():
    ...
    rangeStart = numApplicants
    rangeEnd = numApplicants+numAgents
...
pio.write_image(fig, os.path.dirname(os.path.abspath(__file__)) + '/images/plot3b.svg')
