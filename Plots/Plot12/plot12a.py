...
df = pandas.read_csv(os.path.dirname(os.path.abspath(__file__)) + '/data/optimal/global-response.csv')
response = df.iloc[40]
...
pio.write_image(fig, os.path.dirname(os.path.abspath(__file__)) + '/images/plot12a.svg')
